...
def compute_diff_Ez_4():
    ...
    dEdx[0] = (-55/378 * Ez[0] + 5/21 * Ez[1] -5/42 * Ez[2] + 5/189 * Ez[3]) / dx / P_half_4[0]
    dEdx[1] = (-2783/3072 * Ez[0] + 847/1024 * Ez[1] + 121/1024 * Ez[2] -121/3072 * Ez[3]) / dx / P_half_4[1]
    dEdx[2] = (1085/27648 * Ez[0] -1085/1024 * Ez[1] + 1085/1024 * Ez[2] -1085/27648 * Ez[3]) / dx / P_half_4[2]
    dEdx[3] = (17/9216 * Ez[0] + 37/1024 * Ez[1] -3575/3072 * Ez[2] +10759/9216 * Ez[3] - 1/24 * Ez[4]) / dx / P_half_4[3]
    dEdx[4] = (667/64512 * Ez[0] -899/21504 * Ez[1] + 753/7168 * Ez[2] -74635/64512 * Ez[3] + 9/8 * Ez[4] - 1/24 * Ez[5]) / dx / P_half_4[4]

    dEdx[-1] = (55/378 * Ez[-1] - 5/21 * Ez[-2] + 5/42 * Ez[-3] - 5/189 * Ez[-4]) / dx / P_half_4[-1]
    dEdx[-2] = (2783/3072 * Ez[-1] - 847/1024 * Ez[-2] - 121/1024 * Ez[-3] + 121/3072 * Ez[-4]) / dx / P_half_4[-2]
    dEdx[-3] = (- 1085/27648 * Ez[-1] + 1085/1024 * Ez[-2] - 1085/1024 * Ez[-3] + 1085/27648 * Ez[-4]) / dx / P_half_4[-3]
    dEdx[-4] = (- 17/9216 * Ez[-1] - 37/1024 * Ez[-2] + 3575/3072 * Ez[-3] - 10759/9216 * Ez[-4] + 1/24 * Ez[-5]) / dx / P_half_4[-4]
    dEdx[-5] = (- 667/64512 * Ez[-1] + 899/21504 * Ez[-2] - 753/7168 * Ez[-3] + 74635/64512 * Ez[-4] - 9/8 * Ez[-5] + 1/24 * Ez[-6]) / dx / P_half_4[-5]

    dEdx[5:(Nx_half - 5)] = (N.roll(Ez, 2)[5:(Nx_half - 5)] - 27.0 * N.roll(Ez, 1)[5:(Nx_half - 5)] + 27.0 * Ez[5:(Nx_half - 5)] - N.roll(Ez, -1)[5:(Nx_half - 5)]) / (24.0 * dx)

def compute_diff_By_4():
  
    dBdx[0] = (-323/378 * By[0] + 2783/3072 * By[1] -1085/27648 * By[2] -17/9216 * By[3] -667/64512 * By[4]) / dx / P_int_4[0]
    dBdx[1] = (-5/21 * By[0] -847/1024 * By[1] + 1085/1024 * By[2] -37/1024 * By[3] +  899/21504 * By[4]) / dx / P_int_4[1]
    dBdx[2] = (5/42 * By[0] -121/1024 * By[1] -1085/1024 * By[2] + 3575/3072 * By[3] -753/7168 * By[4]) / dx / P_int_4[2]
    dBdx[3] = (-5/189 * By[0] + 121/3072 * By[1] + 1085/27648 * By[2] -10759/9216 * By[3] + 74635/64512 * By[4] - 1/24 * By[5]) / dx / P_int_4[3]

    dBdx[-1] = (323/378 * By[-1] - 2783/3072 * By[-2] + 1085/27648 * By[-3] + 17/9216 * By[-4] + 667/64512 * By[-5]) / dx / P_int_4[-1]
    dBdx[-2] = (5/21 * By[-1] + 847/1024 * By[-2] - 1085/1024 * By[-3] + 37/1024 * By[-4] - 899/21504 * By[-5]) / dx / P_int_4[-2]
    dBdx[-3] = (- 5/42 * By[-1] + 121/1024 * By[-2] + 1085/1024 * By[-3] - 3575/3072 * By[-4] + 753/7168 * By[-5]) / dx / P_int_4[-3]
    dBdx[-4] = (5/189 * By[-1] - 121/3072 * By[-2] - 1085/27648 * By[-3] + 10759/9216 * By[-4] - 74635/64512 * By[-5] + 1/24 * By[-6]) / dx / P_int_4[-4]

    dBdx[4:(Nx_int - 4)] = (N.roll(By, 1)[4:(Nx_int - 4)] - 27.0 * By[4:(Nx_int - 4)] + 27.0 * N.roll(By, -1)[4:(Nx_int - 4)] - N.roll(By, -2)[4:(Nx_int - 4)]) / (24.0 * dx)
